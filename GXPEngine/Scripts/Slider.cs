...
public class Slider : GameObject
{
    ...
    public Slider(String trackImg, String trackFrontImg, String trackBackImg, String sliderImg, String thumbImg, String sliderBackImg, int x, int y, float min, float max, int currentValue) : base()
    {
